...
#include <autoware_mapping_msgs/msg/had_map_bin.hpp>
 ...
 */
void toBinMsg(const lanelet::LaneletMapPtr & map, autoware_mapping_msgs::msg::HADMapBin * msg);
 ...
 */
void fromBinMsg(const autoware_mapping_msgs::msg::HADMapBin & msg, lanelet::LaneletMapPtr map);
void fromBinMsg(
  const autoware_mapping_msgs::msg::HADMapBin & msg, lanelet::LaneletMapPtr map,
